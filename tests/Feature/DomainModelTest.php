...
class DomainModelTest extends TestCase
{
    ...
    public function test_vendor_valid_npwp_and_delete(): void
    {
        ...
        $client = Client::create(['name' => 'Client Vendor Test']);
    ...
    public function test_purchase_order_mode_and_closed_period_restrictions(): void
    {
        ...
        $clientPo = Client::create(['name' => 'Client PO Test']);
        $project = Project::create([
            'client_id' => $clientPo->id,
            'code' => 'PRJ-TEST-PO',
            'name' => 'Project A',
            'status' => 'active',
            'fiscal_mode' => FiscalMode::PPN,
    ...
    {
        $this->markTestIncomplete('Automatic journal entry posting on invoice issue and kwitansis table will be implemented with settlement flow.');
    }
