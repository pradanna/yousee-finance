...
export default function ClientFormModal({ isOpen, onClose, onSubmit }: ClientFormModalProps) {
        ...
        <Modal show={isOpen} onClose={onClose} maxWidth="xl" closeable={false}>
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div className="flex items-start gap-4 pb-4 border-b border-slate-100">
                    ...
                    <div>
                        <h3 className="text-base font-bold text-slate-800 tracking-tight">Daftarkan Client Baru</h3>
                        <p className="text-xs text-slate-500 mt-0.5">
                            Tambahkan profil mitra client pengiklan Yousee Indonesia untuk pembuatan Invoice.
                        </p>
                    </div>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <InputLabel htmlFor="client-name" value="Nama Lengkap Client *" />
                            <TextInput
                                id="client-name"
                                type="text"
                                value={form.name}
                        ...
                        <div>
                            <InputLabel htmlFor="client-npwp" value="NPWP Resmi Client" />
                            <TextInput
                                id="client-npwp"
                                type="text"
                                value={form.npwp}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <InputLabel htmlFor="client-email" value="Email Kontak Finance" />
                            <TextInput
                                id="client-email"
                                type="email"
                                value={form.email}
                        ...
                        <div>
                            <InputLabel htmlFor="client-phone" value="Telepon / WhatsApp" />
                            <TextInput
                                id="client-phone"
                                type="text"
                                value={form.phone}
                    ...
                    {/* Alamat Lengkap */}
                    <div>
                        <InputLabel htmlFor="client-address" value="Alamat Kantor Client" />
                        <textarea
                            id="client-address"
                            value={form.address}
                    ...
                    <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                        ...
                        <div className="space-y-0.5">
                            <label htmlFor="client-pkp-checkbox" className="text-xs font-bold text-slate-700 cursor-pointer block">
                                Status Wajib PPN (PKP)
                            </label>
                            <span className="text-[10px] text-slate-400 font-semibold block leading-tight">
                                Centang jika client menghendaki Faktur Pajak PPN Keluaran (11%) resmi.
                            </span>
                        </div>
                    </div>
                </div>
